  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        <>
          {data && (
            <div className="hotelContainer" key={data._id}>
              {slideOpen && (
              ...
              <div className="hotelWrapper">
                ...
                <span className="hotelDistance">
                  Excellent locaion - {data.distance}m from center
                </span>
                <span className="hotelPriceHighlight">
                  Book a stay over <span>&#8377;{data.cheapestPrice}</span> at
                ...
                <div className="hotelDetails">
                  <div className="hotelDetailsTexts">
                    ...
                    <p className="hotelDesc">
                      ...
                      Blanditiis eaque deserunt nulla tempora iusto nesciunt
                      incidunt totam vel quasi ea? Doloribus ex aliquid nisi
                      voluptatum! Excepturi neque alias asperiores quae.
                    </p>
                  </div>
                  <div className="hotelDetailsPrice">
                    ...
                    <h2>
                      <b>&#8377;{data.cheapestPrice}</b> (9 night)
                    </h2>
